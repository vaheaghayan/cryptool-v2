<x-app-layout>
    ...
    <h4 style="margin-top: 50px">
        ...
        @auth()
            <a href="{{url(cLng() . '/' . $cipher->category .'/' . $cipher->name .' /test')}}"><button type="button" class="btn btn-secondary">Run the cypher</button></a>
        @else
    ...
    <script src="{{asset('resources/js/static/modal.js')}}"></script>
